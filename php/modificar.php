...
<html lang="en">
  ...
  <?php
	...
	<!-- Fin-->
  <div class="container">
      <form method="POST" action="Pacientes_methods/update_paciente.php?id=<?php echo $row['cedula'];?>"  >
        <div class="row main">
            <div class="col-xs-6 col-md-*">
              ...
              ?>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input value="<?php echo $row['cedula'] ?>" name="cedula" type="text" class="form-control form-control-sm" id="cedula" placeholder="Cédula Afiliacion" readonly>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="Paciente" class="col-sm-4 col-form-label col-form-label-lg">Numero de Paciente</label>
                      <div class="col-sm-8">
                        <input value="<?php echo $row['no_paciente'] ?>" name="no_paciente" type="text" class="form-control form-control-sm" id="Paciente" placeholder="Numero Paciente" >
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input value="<?php echo $row['nombre']?>" name="nombre" type="text" onkeyup="mayus(this)" class="form-control form-control-sm" id="Nombre" placeholder="Nombre" >
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input value="<?php echo $row['edad'] ?>" name="edad" type="number" class="form-control form-control-sm" id="edad" placeholder="Edad" >
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                       <!-- <input value="< echo $row['estado'] ?>" name="estado" type="text" class="form-control form-control-sm" id="estado" placeholder="Estado" >-->
                        <input value="<?php echo $row['estado'] ?>" name="estado" type="text" class="form-control form-control-sm" id="estado" placeholder="Estado" readonly>
              ...
              <div class="btn-group col-sm-5 col-lg-offset-7">
                <input onclick="LimpiarPacientes_1()" type="button" class="btn btn-warning btn-block" value="Limpiar"/>
              </div>               
            </div>
            <div class="col-xs-6 col-md-*">
              <div class="panel-heading" align="center">
              ...
              ?>
                  ...
                  <div class="form-group row">
                      <label for="Nombre" class="col-sm-4 col-form-label col-form-label-lg">Nombre(s)</label>
                      <div class="col-sm-8">
                        <input value="<?php echo $row['familiar_responsable'] ?>" name="nombre_f" onkeyup="mayus(this)" type="text" class="form-control form-control-sm" id="Nombre_fav" placeholder="Nombre" >
                      </div>
                  </div>
                  <div class="form-group row">
                      <label for="Parentesco" class="col-sm-4 col-form-label col-form-label-lg">Parentesco</label>
                      <div class="col-sm-8">
                        <input  value="<?php echo $row['parentesco'] ?>" maxlength="45" onkeyup="mayus(this)" name="parentesco" type="text" class="form-control form-control-sm" id="Parentesco" placeholder="Parentesco" required>
                      </div>
                  </div>
                  <div class="form-group row">
              ...
              <div class="panel-heading" align="center">
                ...
                <div class="form-group col-md-12">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input onkeyup="mayus(this)" value="<?php echo $row['ciudad'] ?>" name="ciudad" type="text" class="form-control form-control-sm" id="ciudad" placeholder="Ciudad" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="municipio" class="col-sm-4 col-form-label col-form-label-lg">Municipio</label>
                      <div class="col-sm-8">
                        <input onkeyup="mayus(this)" value="<?php echo $row['municipio'] ?>" name="municipio" type="text" class="form-control form-control-sm" id="municipio" placeholder="Municipio" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="colonia" class="col-sm-4 col-form-label col-form-label-lg">Colonia</label>
                      <div class="col-sm-8">
                        <input onkeyup="mayus(this)"  value="<?php echo $row['colonia'] ?>" name="colonia" type="text" class="form-control form-control-sm" id="colonia" placeholder="Colonia" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="cp" class="col-sm-4 col-form-label col-form-label-lg">Codigo Postal</label>
                      <div class="col-sm-8">
                        <input  value="<?php echo $row['cp'] ?>" name="cp" type="text" class="form-control form-control-sm" id="cp" placeholder="Codigo Postal" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="calle" class="col-sm-4 col-form-label col-form-label-lg">Calle</label>
                      <div class="col-sm-8">
                        <input onkeyup="mayus(this)" value="<?php echo $row['calle'] ?>" name="calle" type="text" class="form-control form-control-sm" id="calle" placeholder="Calle" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="calle2" class="col-sm-4 col-form-label col-form-label-lg">Entre Calle 1</label>
                      <div class="col-sm-8">
                        <input onkeyup="mayus(this)" value="<?php echo $row['entre_calle1'] ?>" name="calle_1" type="text" class="form-control form-control-sm" id="calle1" placeholder="Entre Calle">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="calle2" class="col-sm-4 col-form-label col-form-label-lg">Entre Calle 2</label>
                      <div class="col-sm-8">
                        <input onkeyup="mayus(this)" value="<?php echo $row['entre_calle2'] ?>" name="calle_2" type="text" class="form-control form-control-sm" id="calle2" placeholder="Entre Calle">
                      </div>
                    </div>  
          ...
          <div class="col-xs-6 col-md-*">
              ...
              <div class="form-group col-md-12">
                    <div class="form-group">
                      ...
                      <textarea onkeyup="mayus(this)" id="observaciones" value="" name="observaciones"  class="form-control" rows="16" ><?php echo $row['observaciones'];?></textarea>
                    </div>
